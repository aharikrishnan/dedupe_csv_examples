...
input_file = 'gem_500.tsv'
output_file = 'gem_output.csv'
settings_file = 'gem_learned_settings'
training_file = 'gem_training.json'

def cleanseBrand(column):
    if column:
...
def readData(filename):
    ...
    with open(filename) as f:
        ...
        for row in reader:
            ...
            clean_row['p_brand'] = cleanseBrand(clean_row['p_brand'])
...
if os.path.exists(settings_file):
    ...
    fields = [
        {'field' : 'p_brand', 'type': 'String'},
        {'field' : 'pc_cat_name', 'type': 'String'}
        ]
